...
fn binary_with_debug() {
    ...
    p.root().join("build-dir").assert_file_layout(str![[r#"
...
"#]]);
    ...
    p.root().join("target-dir").assert_file_layout(str![[r#"
...
fn should_default_to_target() {
    ...
    p.root().join("target").assert_file_layout(str![[r#"
...
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/build-script/build_script_build-[HASH].d
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/build-script/build_script_build-[HASH]
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/build-script/build-script-build
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/fingerprint/invoked.timestamp
...
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/fingerprint/bin-foo.json
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/deps/foo-[HASH].d
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/deps/foo-[HASH]
[ROOT]/foo/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/fingerprint/invoked.timestamp
...
[ROOT]/foo/build-dir/debug/.cargo-lock
[ROOT]/foo/build-dir/debug/foo[EXE]
[ROOT]/foo/build-dir/debug/foo[EXE].d
...
fn template_workspace_path_hash() {
    ...
    // Verify the binary was uplifted to the target-dir
    assert_exists(&p.root().join(&format!("target-dir/debug/foo{EXE_SUFFIX}")));
    build_dir.assert_file_layout(str![[r#"
...
fn template_workspace_path_hash_should_handle_symlink() {
    ...
    original_hash_dir.assert_file_layout(str![[r#"
[ROOT]/foo/foo/[HASH]/build-dir/.rustc_info.json
[ROOT]/foo/foo/[HASH]/build-dir/[HOST_TARGET]/CACHEDIR.TAG
[ROOT]/foo/foo/[HASH]/build-dir/[HOST_TARGET]/debug/.cargo-lock
...
"#]]);
    ...
    symlink_hash_dir.assert_file_layout(str![[r#"
[ROOT]/foo/foo/[HASH]/build-dir/.rustc_info.json
[ROOT]/foo/foo/[HASH]/build-dir/[HOST_TARGET]/CACHEDIR.TAG
[ROOT]/foo/foo/[HASH]/build-dir/[HOST_TARGET]/debug/.cargo-lock
[ROOT]/foo/foo/[HASH]/build-dir/[HOST_TARGET]/debug/build/foo-[HASH]/deps/foo-[HASH].d
