...
### 11. PR 31 deferred (heavy lift, acknowledged, not in this batch)

The following CodeRabbit items were verified as valid but deferred to a follow-up PR to keep this batch small and testable (14/14 `build_cache` tests already green):
